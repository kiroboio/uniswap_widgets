...
import React, { useContext, createContext, useMemo, useEffect, useState, useCallback, useRef, forwardRef, Children, Component, StrictMode, useReducer } from 'react';
import { Token, WETH9, NativeCurrency, Ether, CurrencyAmount, Percent, TradeType, Price } from '@uniswap/sdk-core';
...
import { FACTORY_ADDRESS, Pair, computePairAddress, Trade, Route as Route$1 } from '@uniswap/v2-sdk';
import { FACTORY_ADDRESS as FACTORY_ADDRESS$1, computePoolAddress, Pool, FeeAmount, Route, SwapQuoter } from '@uniswap/v3-sdk';
...
import { Trade as Trade$1, Protocol } from '@uniswap/router-sdk';
...
import { ArrowDown, ArrowRight, ArrowUp, CheckCircle, BarChart2, ChevronDown, Clock, HelpCircle, Info, ExternalLink, Settings, Slash, Trash2, X, XOctagon, AlertTriangle as AlertTriangle$1 } from 'react-feather';
import { createPortal } from 'react-dom';
import { transparentize, mix } from 'polished';
import 'wcag-contrast';
import _extends$3 from '@babel/runtime/helpers/extends';
...
var _initializeConnector = initializeConnector(function () {
  return EMPTY;
}),
  ...
  var network = useMemo(function () {
    if (jsonRpcEndpoint) {
      ...
      if (JsonRpcProvider.isProvider(jsonRpcEndpoint)) {
        ...
        var _initializeConnector3 = initializeConnector(function (actions) {
          return new JsonRpcConnector(actions, jsonRpcEndpoint);
        });

        var _initializeConnector4 = _slicedToArray(_initializeConnector3, 2);

        _connector = _initializeConnector4[0];
        _hooks = _initializeConnector4[1];
      } else {

        var _initializeConnector5 = initializeConnector(function (actions) {
          return new Url(actions, jsonRpcEndpoint);
        });

        var _initializeConnector6 = _slicedToArray(_initializeConnector5, 2);
  ...
  var wallet = useMemo(function () {
    if (provider) {
      ...
      if (JsonRpcProvider.isProvider(provider)) {
        ...
        var _initializeConnector7 = initializeConnector(function (actions) {
          return new JsonRpcConnector(actions, provider);
        });

        var _initializeConnector8 = _slicedToArray(_initializeConnector7, 2);
        ...
        var _initializeConnector9 = initializeConnector(function (actions) {
          return new EIP1193(actions, provider);
        });

        var _initializeConnector10 = _slicedToArray(_initializeConnector9, 2);
...
constructSameAddressMap('0xE592427A0AEce92De3Edee1F18E0157C05861564', [SupportedChainId.OPTIMISM, SupportedChainId.OPTIMISTIC_KOVAN, SupportedChainId.ARBITRUM_ONE, SupportedChainId.ARBITRUM_RINKEBY, SupportedChainId.POLYGON, SupportedChainId.POLYGON_MUMBAI]);
constructSameAddressMap('0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45', [SupportedChainId.OPTIMISM, SupportedChainId.OPTIMISTIC_KOVAN, SupportedChainId.ARBITRUM_ONE, SupportedChainId.ARBITRUM_RINKEBY, SupportedChainId.POLYGON, SupportedChainId.POLYGON_MUMBAI]);
/**
...
var reducer$1 = combineReducers(_defineProperty({}, multicall.reducerPath, multicall.reducer));
...
_objectSpread$7(_objectSpread$7({}, WRAPPED_NATIVE_CURRENCIES_ONLY), {}, _defineProperty({}, SupportedChainId.MAINNET, [].concat(_toConsumableArray(WRAPPED_NATIVE_CURRENCIES_ONLY[SupportedChainId.MAINNET]), [DAI, USDC_MAINNET, USDT, WBTC])));
...
var PAIR_INTERFACE = new Interface(abi$3);
var PairState;
    ...
    if (amountSpecified && currencyIn && currencyOut && allowedPairs.length > 0) {
      ...
      for (var i = 1; i <= maxHops; i++) {
        ...
        if (tradeType === TradeType.EXACT_INPUT) {
          ...
          currentTrade = (_Trade$bestTradeExact3 = Trade.bestTradeExactIn(allowedPairs, _amountIn, currencyOut, _options)[0]) !== null && _Trade$bestTradeExact3 !== void 0 ? _Trade$bestTradeExact3 : null;
        } else {
          var _Trade$bestTradeExact4;

          var _amountOut = amountSpecified;
          currentTrade = (_Trade$bestTradeExact4 = Trade.bestTradeExactOut(allowedPairs, currencyIn, _amountOut, _options)[0]) !== null && _Trade$bestTradeExact4 !== void 0 ? _Trade$bestTradeExact4 : null;
...
var InterfaceTrade = /*#__PURE__*/function (_Trade) {
  ...
  function InterfaceTrade(_ref) {
    ...
    var gasUseEstimateUSD = _ref.gasUseEstimateUSD,
        routes = _objectWithoutProperties(_ref, _excluded$2);
...
function useClientSideSmartOrderRouterTrade(tradeType, amountSpecified, otherCurrency) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.prev = 4;
            _context.next = 7;
            return import('./clientSideSmartOrderRouter-9a2469fa.js');
  ...
  var _ref5 = (_usePoll = usePoll(getQuoteResult, JSON.stringify(queryArgs), {
    ...
    isStale: useCallback(function (_ref6) {
      var data = _ref6.data;
...
var DEFAULT_SWAP_INFO = (_DEFAULT_SWAP_INFO = {}, _defineProperty(_DEFAULT_SWAP_INFO, Field.INPUT, {}), _defineProperty(_DEFAULT_SWAP_INFO, Field.OUTPUT, {}), _defineProperty(_DEFAULT_SWAP_INFO, "trade", INVALID_TRADE), _defineProperty(_DEFAULT_SWAP_INFO, "slippage", DEFAULT_SLIPPAGE), _DEFAULT_SWAP_INFO);
...
function a(e) {
  return function (e) {
    return function (t) {
      var r = o(),
          a = r.i18n;
      return /*#__PURE__*/React.createElement(e, Object.assign({}, t, {
        i18n: a
      }));
    };
  };
...
var i = function i(t) {
  ...
  }, []), c && "default" === h ? null : /*#__PURE__*/React.createElement(r.Provider, {
    value: m,
    key: h
  }, u);
};
...
function y(t) {
  ...
  g && Object.keys(g).forEach(function (e) {
    ...
    if ( /*#__PURE__*/React.isValidElement(t)) {
    ...
    try {
      for (y.s(); !(v = y.n()).done;) {
        var h = _slicedToArray(v.value, 3),
            ...
            O = h[2],
            j = o[b];
        (!j || s[j.type] && g) && (j ? console.error("".concat(j.type, " is a void element tag therefore it must have no children")) : console.error("Can use element at index '".concat(b, "' as it is not declared in the original translation")), j = /*#__PURE__*/React.createElement(React.Fragment)), u.push( /*#__PURE__*/React.cloneElement(j, {
          key: a()
  ...
  var P = d || E;
  return /*#__PURE__*/React.createElement(P, null, w);
}
...
keyframes(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
...
function Subhead1(props) {
  return /*#__PURE__*/React.createElement(TextWrapper, _extends$3({
...
function TransitionButton(props) {
  ...
  return /*#__PURE__*/React.createElement(TransitionTextWrapper, _extends$3({
    className: className,
    fontSize: fontSize,
    fontWeight: 500,
...
var IconButton = /*#__PURE__*/forwardRef(function IconButton(_ref7, ref) {
  var Icon = _ref7.icon,
      ...
      props = _objectWithoutProperties(_ref7, _excluded$1);

  return /*#__PURE__*/React.createElement(SecondaryButton, _extends$3({}, props, {
    ref: ref
...
function Dialog(_ref5) {
  ...
  return context.element && /*#__PURE__*/createPortal( /*#__PURE__*/React.createElement(ThemeProvider, null, /*#__PURE__*/React.createElement(OnCloseContext.Provider, {
    value: onClose
...
var grow = keyframes(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  from {\n    opacity: 0;\n    width: 0;\n  }\n  to {\n    opacity: 1;\n    width: max-content;\n  }\n"])));

var actionCss = css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  border: 1px solid ", ";\n  padding: calc(0.25em - 1px);\n  padding-left: calc(0.75em - 1px);\n\n  ", " {\n    animation: ", " 0.25s ease-in;\n    flex-grow: 1;\n    justify-content: flex-start;\n    white-space: nowrap;\n  }\n\n  ", " {\n    border-radius: ", "em;\n    flex-grow: 0;\n    padding: 1em;\n  }\n"])), function (_ref2) {
...
function ActionButton(_ref6) {
  ...
  return /*#__PURE__*/React.createElement(Overlay, {
    ...
    flex: true,
    align: "stretch"
  }, (action ? action.onClick : true) && /*#__PURE__*/React.createElement(StyledButton, {
    color: color,
    disabled: disabled,
    onClick: (action === null || action === void 0 ? void 0 : action.onClick) || onClick
  }, /*#__PURE__*/React.createElement(TransitionButton, {
...
function Expando(_ref4) {
  ...
  return /*#__PURE__*/React.createElement(Column, null, /*#__PURE__*/React.createElement(HeaderColumn, {
    gap: open ? 0.5 : 0.75
  }, /*#__PURE__*/React.createElement(Rule, null), /*#__PURE__*/React.createElement(Row, null, title, /*#__PURE__*/React.createElement(IconButton, {
    color: "secondary",
    onClick: onExpand,
    icon: Expando$1,
    iconProps: {
  ...
  })), /*#__PURE__*/React.createElement(Rule, null)), /*#__PURE__*/React.createElement(ExpandoColumn, {
    open: open,
    height: height
...
var ErrorHeader = /*#__PURE__*/_styled(Column).withConfig({
...
function ErrorDialog(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(Column, {
    ...
    iconColor: "error",
    iconSize: open ? 3 : 4
  }, /*#__PURE__*/React.createElement(ErrorHeader, {
    gap: open ? 0 : 0.75,
    open: open
  }, /*#__PURE__*/React.createElement(Subhead1, null, /*#__PURE__*/React.createElement(Trans, {
    id: "Something went wrong."
  })), /*#__PURE__*/React.createElement(Body2, null, header))), /*#__PURE__*/React.createElement(Column, {
    gap: open ? 0 : 0.75,
    style: {
      transition: 'gap 0.25s'
    }
    ...
    userSelect: true
  }, error.name, error.message ? ": ".concat(error.message) : '')), /*#__PURE__*/React.createElement(ActionButton, {
    onClick: onClick
  }, action)));
}
...
var SwapValuesProvider = function SwapValuesProvider(props) {
  ...
  }, /*#__PURE__*/React.createElement(Wrapper, rest, /*#__PURE__*/React.createElement(Swap, rest, children))));
};
var useDispatchSwapValues = function useDispatchSwapValues() {
  var context = React.useContext(DispatchSwapValues);
...
export { DEFAULT_LOCALE, SUPPORTED_LOCALES, SupportedChainId, SwapValuesProvider, darkTheme, defaultTheme, lightTheme, useDispatchSwapValues, useSwapValues };
